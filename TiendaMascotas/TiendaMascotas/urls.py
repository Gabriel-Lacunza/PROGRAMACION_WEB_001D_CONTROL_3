...
urlpatterns = [
    ...
    path('mantenedorProducto/<int:idProducto>/<str:action>', mantenedor_de_productos, name='mantenedorProducto'),
    path('mantenedorUsuario/', mantenedor_de_usuarios, name='mantenedorUsuario'),
